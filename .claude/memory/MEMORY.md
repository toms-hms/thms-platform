...
- [THM-20 Recipe Audit](thm-20_recipe-audit.md) — Patterns established during recipe review: TypedRequest, homeJobRouter, schema naming, service=mutations only, buildUrl; two pending code changes
